...
| [`29-缺测改造-设计与实现规格`](29-缺测改造-设计与实现规格.md) | 缺测改造（S-2/S-3/S-9/S-10/1.2.0 取数 + 缺测 sentinel 契约 + 执行侧买入拦截/持仓卖出 + E-6 + J-3 日历接口 + J-1/J-8/S-12）的**自包含实现规格**，供独立会话执行；含已落地基础、已查明关键事实、依赖顺序与各子项验收。第七轮单仓修复与 J-4/5/6 已提交（见 ③ 状态概要） |
